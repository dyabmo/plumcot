...
def validate_ev(x_paths, y_paths, weights_dir):
...
def compute_precision_recall():
    ...
    y_true_curve, y_pred_curve = validate_ev(X_PATHS_DEV_AUDIO,Y_PATHS_DEV,WEIGHTS_DIR)
...
for beta in (1,0.1,10):
    ...
    print(beta)
    #Apply dev set
    y_true, y_pred = validate_ev(X_PATHS_DEV_AUDIO,Y_PATHS_DEV,WEIGHTS_DIR)
    ...
    y_true_test, y_pred_test = validate_ev(X_PATHS_TEST_AUDIO,Y_PATHS_TEST,WEIGHTS_DIR)
