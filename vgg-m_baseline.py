...
def set_no_samples(train_dir,dev_dir=None):
    ...
    print("Validation number of samples: "+str(training_validation_no_samples))
...
def generate_imges_from_hdf5(file,type="training"):
    ...
    if(type=="training"):
        ...
        index = training_validation_no_samples
...
def calculate_steps_per_epoch():
    ...
    training_validation_steps = int(training_validation_no_samples/batch_size / 2)
...
def save_model():
    ...
    model.save('/vol/work1/dyab/training_models/vgg-m_IMG224_SGD_binary-crossentropy.h5')
